...
func GetMaroonedPodsSubresourceClientFromFlags(master string, kubeconfig string) (MaroonedPodsClient, error) {
	...
	generatedMaroonedPodsClient, err := generatedclient.NewForConfig(config)
	if err != nil {
		return nil, err
	}
...
func GetMaroonedPodsSubresourceClient() (MaroonedPodsClient, error) {
	return GetMaroonedPodsSubresourceClientFromFlags(master, kubeconfig)
}
