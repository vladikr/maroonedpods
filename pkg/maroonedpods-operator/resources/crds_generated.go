...
// MaroonedPodsCRDs is a map containing yaml strings of all CRDs
var MaroonedPodsCRDs map[string]string = map[string]string{
	"maroonedpods": `apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
    controller-gen.kubebuilder.io/version: v0.11.3
  creationTimestamp: null
  name: maroonedpods.maroonedpods.io
spec:
  group: maroonedpods.io
  names:
    kind: MaroonedPods
  ...
  - additionalPrinterColumns:
    ...
    schema:
      openAPIV3Schema:
        description: MaroonPods is the MaroonPods Operator CRD
        properties:
          apiVersion:
          ...
          metadata:
            type: object
          spec:
            description: MaroonedPodsSpec defines our specification for the MaroonedPods
              installation
            properties:
              certConfig:
              ...
              imagePullPolicy:
                ...
                type: string
              infra:
                description: Rules on which nodes MaroonedPods infrastructure pods
                  will be scheduled
                properties:
                  affinity:
              ...
              namespaceSelector:
                ...
                x-kubernetes-map-type: atomic
              priorityClass:
                description: PriorityClass of the MaroonedPods control plane
                type: string
              workload:
                description: Restrict on which nodes MaroonedPods workload pods will
                  be scheduled
                properties:
                  affinity:
                    description: affinity enables pod affinity/anti-affinity placement
            ...
            type: object
          status:
            description: MaroonedPodsStatus defines the status of the installation
            properties:
              conditions:
...
status:
  ...
  storedVersions: null
`,
	"maroonedpodsconfig": `apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
    controller-gen.kubebuilder.io/version: v0.11.3
  creationTimestamp: null
  name: maroonedpodsconfigs.maroonedpods.io
spec:
  group: maroonedpods.io
  names:
    kind: MaroonedPodsConfig
    listKind: MaroonedPodsConfigList
    plural: maroonedpodsconfigs
    shortNames:
    - mpconfig
    - mpconfigs
    singular: maroonedpodsconfig
  scope: Cluster
  versions:
  - additionalPrinterColumns:
    - jsonPath: .spec.nodeImage
      name: Node Image
      type: string
    - jsonPath: .spec.warmPoolSize
      name: Warm Pool Size
      type: integer
    - jsonPath: .metadata.creationTimestamp
      name: Age
    ...
    schema:
      openAPIV3Schema:
        description: MaroonedPodsConfig is the configuration for MaroonedPods virtual
          nodes
        properties:
          apiVersion:
            description: 'APIVersion defines the versioned schema of this representation
          ...
          metadata:
            type: object
          spec:
            description: MaroonedPodsConfigSpec defines the configuration for MaroonedPods
              behavior
            properties:
              baseVMResources:
                description: Base VM resources (CPU/memory) for virtual nodes These
                  are the resources allocated to the VM itself
                properties:
                  cpu:
                    default: 2
                    description: 'CPU cores for the VM (default: 2)'
                    format: int32
                    type: integer
                  memoryMi:
                    default: 3072
                    description: 'Memory for the VM in Mi (default: 3072 = 3Gi)'
                    format: int64
                    type: integer
                type: object
              nodeImage:
                default: quay.io/capk/ubuntu-2004-container-disk:v1.26.0
                description: 'Container disk image to use for virtual node VMs Default:
              ...
              resourceOverhead:
                ...
                description: 'Resource overhead to add on top of pod requests for
                  VM sizing This accounts for kubelet, kube-proxy, and other node
                  components Default: 500m CPU, 512Mi memory'
                type: object
              warmPoolSize:
                default: 0
                description: 'Number of pre-booted VM nodes to keep in warm pool Default:
                  0 (disabled)'
                format: int32
                minimum: 0
                type: integer
            type: object
          status:
            description: MaroonedPodsConfigStatus defines the observed state of MaroonedPodsConfig
            properties:
              conditions:
                ...
                type: array
              warmPoolAvailable:
                description: Number of available (unclaimed) VMs in the warm pool
                format: int32
                type: integer
              warmPoolClaimed:
                description: Number of claimed VMs currently in use
                format: int32
                type: integer
              warmPoolTotal:
                description: Total number of VMs in the warm pool
                format: int32
                type: integer
            type: object
        required:
