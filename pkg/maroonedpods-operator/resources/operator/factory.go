...
import (
	...
	"maroonedpods.io/maroonedpods/pkg/marooned-operator/resources/namespaced"
...
// ClusterServiceVersionData - Data arguments used to create MaroonedPods's CSV manifest
