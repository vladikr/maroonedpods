...
type templateData struct {
	...
	MaroonedPodsServerImage         string
	ClonerImage            string
...
func generateFromFile(templFile string) {
	data := &templateData{
		...
		MaroonedPodsServerImage:         *maroonedPodsServerImage,
...
func getOperatorResources(resourceGroup string) ([]client.Object, error) {
	...
	return mpoperator.CreateOperatorResourceGroup(resourceGroup, args)
}

func getNamespacedResources(codeGroup string) ([]client.Object, error) {
	args := &mpnamespaced.FactoryArgs{
		Verbosity:       *verbosity,
		OperatorVersion: *operatorVersion,
		ControllerImage: *controllerImage,
		MaroonedPodsServerImage:  *maroonedPodsServerImage,
	...
	return mpnamespaced.CreateResourceGroup(codeGroup, args)
}
