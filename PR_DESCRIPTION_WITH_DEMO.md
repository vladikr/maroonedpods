...
**Watch the full automation in action:** https://asciinema.org/a/uepkE44Iu42ZGWVe

[![asciicast](https://asciinema.org/a/uepkE44Iu42ZGWVe.svg)](https://asciinema.org/a/uepkE44Iu42ZGWVe)

The demo shows the complete lifecycle:
- Pods created with MaroonedPods labels → immediately gated
- VMI auto-created with RHCOS
- VM boots and requests bootstrap CSR → auto-approved
- Node registers to cluster
- Serving CSR requested → auto-approved
- Node becomes Ready
- Pods ungated and scheduled to dedicated node
- **Zero manual intervention, ~3 minutes end-to-end**
